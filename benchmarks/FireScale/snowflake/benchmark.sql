...
FROM uservisits
WHERE (visitdate >= '2021-03-24' AND visitdate <= DATEADD('DAY', 1, '2021-03-24'));
...
FROM uservisits
WHERE (visitdate >= '2022-10-06' AND visitdate <= DATEADD('DAY', 1, '2022-10-06'))
...
WHERE
  ...
  uv.visitdate >= '2022-11-21' AND uv.visitdate < '2022-12-22'
    ...
    AND (CASE WHEN (CASE
            ...
            WHEN 'Date' = 'Date' AND 'Off' = 'Complete' AND EXTRACT(HOUR FROM CURRENT_TIMESTAMP) >= 9 THEN DATEADD(day, 1, uv.visitdate) > CURRENT_DATE
            WHEN 'Date' = 'Week' AND 'Off' = 'Complete' AND EXTRACT(HOUR FROM CURRENT_TIMESTAMP) >= 9 THEN uv.visitdate >= DATEADD(week, -1, date_trunc('week', CURRENT_DATE))
            WHEN 'Date' = 'Month' AND 'Off' = 'Complete' AND EXTRACT(HOUR FROM CURRENT_TIMESTAMP) >= 9 THEN uv.visitdate >= DATEADD(month, -1, date_trunc('month', CURRENT_DATE))
            WHEN 'Date' = 'Date' AND 'Off' = 'Partial' AND EXTRACT(HOUR FROM CURRENT_TIMESTAMP) >= 9 THEN DATEADD(day, 1, uv.visitdate) > CURRENT_DATE
            WHEN 'Date' = 'Week' AND 'Off' = 'Partial' AND EXTRACT(HOUR FROM CURRENT_TIMESTAMP) >= 9 THEN uv.visitdate >= DATEADD(week, -1, date_trunc('week', CURRENT_DATE))
            WHEN 'Date' = 'Month' AND 'Off' = 'Partial' AND EXTRACT(HOUR FROM CURRENT_TIMESTAMP) >= 9 THEN uv.visitdate >= DATEADD(month, -1, date_trunc('month', CURRENT_DATE))
            WHEN 'Date' = 'Date' AND 'Off' = 'Complete' AND EXTRACT(HOUR FROM CURRENT_TIMESTAMP) < 9 THEN DATEADD(day, 1, uv.visitdate) > CURRENT_DATE
            WHEN 'Date' = 'Week' AND 'Off' = 'Complete' AND EXTRACT(HOUR FROM CURRENT_TIMESTAMP) < 9 THEN uv.visitdate >= DATEADD(week, -1, date_trunc('week', CURRENT_DATE))
            WHEN 'Date' = 'Month' AND 'Off' = 'Complete' AND EXTRACT(HOUR FROM CURRENT_TIMESTAMP) < 9 THEN uv.visitdate >= DATEADD(month, -1, date_trunc('month', CURRENT_DATE))
            WHEN 'Date' = 'Date' AND 'Off' = 'Partial' AND EXTRACT(HOUR FROM CURRENT_TIMESTAMP) < 9 THEN DATEADD(day, 1, uv.visitdate) > CURRENT_DATE
